...
const Home = () => {
    ...
    return (
        <div className="min-h-screen bg-white flex flex-col font-bold overflow-hidden selection:bg-amrita-maroon selection:text-white">
            ...
            {/* Hero Section */}
            {/* Hero Section */}
            <section className="relative h-screen flex items-center justify-center overflow-hidden" style={{ background: 'linear-gradient(to bottom, #ffffff 50%, #fff0f5 100%)' }}>
                {/* Studio Light Effect */}
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div className="space-y-10 animate-slide-in">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/30 backdrop-blur-md rounded-full border border-white/40 shadow-sm">
                            ...
                            <span className="text-[10px] font-black tracking-widest text-gradient uppercase italic">Elite Placement Protocol v4.0</span>
                        </div>
                        <h1 className="text-4xl md:text-6xl font-black leading-[1.1] tracking-tight">
                            <span className="text-gradient">Education</span> <br />
                            <span className="text-gradient">for</span> <span className="text-gradient drop-shadow-2xl italic">Life.</span>
                        </h1>
...
const ValueCard = ({ icon, title, desc }) => (
    <div className="space-y-6 group cursor-default">
        ...
        <h3 className="text-2xl font-black text-gradient tracking-tight">{title}</h3>
