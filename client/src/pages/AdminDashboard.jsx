...
const AdminDashboard = () => {
    ...
    const [isLiveUpdateModalOpen, setIsLiveUpdateModalOpen] = useState(false);
    ...
    const fetchLiveUpdates = async () => {
        try {
            const res = await axios.get(`${import.meta.env.VITE_API_URL || 'http://localhost:5005/api'}/live-updates`);
                    ...
                    {activeTab === 'announcements' && (
                        <div className="glass-card p-6">
                            <div className="flex justify-between items-center mb-6">
                                ...
                                <div className="flex gap-3">
                                    <button
                                        onClick={() => setIsLiveUpdateModalOpen(true)}
                                        className="btn-premium flex items-center gap-2 !bg-gradient-to-r !from-pink-500 !to-rose-500"
                                    >
                                        <Megaphone size={18} /> Live
                                    </button>
                                    <button className="btn-premium flex items-center gap-2" style={{ background: theme.maroon.primary }}>
                            ...
                            <LiveUpdateModal
                                isOpen={isLiveUpdateModalOpen}
                                onClose={() => setIsLiveUpdateModalOpen(false)}
                                onUpdateSuccess={fetchLiveUpdates}
                            />
