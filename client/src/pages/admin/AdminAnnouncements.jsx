                    ...
                    <div className="relative z-10 grid grid-cols-2 lg:grid-cols-4 gap-4 mt-8">
                        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-2xl font-black">{announcementStats.total}</p>
                        ...
                        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-2xl font-black">{announcementStats.active}</p>
                        ...
                        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-2xl font-black">{announcementStats.urgent}</p>
                        ...
                        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-2xl font-black">{announcementStats.thisWeek}</p>
